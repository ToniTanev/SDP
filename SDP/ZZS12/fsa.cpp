...
// state::transitions използва индекси
// DFSA::toState използва индекси
// DFSA::setFinalState използва label-и
// DFSA::addTransition използва label-и
// DFSA[label]['char'] = label
